...
#ifndef _ofxOscTCP_RECEIVER_H
#define _ofxOscTCP_RECEIVER_H
...
class ofxOscTCPClient : public osc::OscPacketListener
{
public:
	ofxOscTCPClient();
	~ofxOscTCPClient();
	...
	void setup( const Poco::Net::SocketAddress &address );
...
protected:
    static void socketListener(void *thisClient);
