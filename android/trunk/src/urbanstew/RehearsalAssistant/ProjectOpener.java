 ...
 *
 *         Handles opening of projects - delegates to appropriate Project
 *         activity depending on the project type.
 * 
 */
public class ProjectOpener extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		Cursor projectsCursor = getContentResolver().query(ContentUris.withAppendedId(Projects.CONTENT_URI, project_id),
