...
public class RehearsalAssistant extends RehearsalActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (preferences.getBoolean("launch_with_last_project", true)) {
			...
			intent = new Intent(Intent.ACTION_VIEW, Projects.CONTENT_URI);
		}
	...
	public static void checkSdCard(Context context) {
		...
		if (!state.equals(android.os.Environment.MEDIA_MOUNTED)) {
			Request.notification(context, context.getString(R.string.media_missing),
					context.getString(R.string.media_missing_msg01) + " " + state + ").  "
							+ context.getString(R.string.media_missing_msg02));
		}
	}
}