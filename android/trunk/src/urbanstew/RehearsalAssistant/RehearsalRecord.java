...
/**
 * The RehearsalRecord Activity handles recording annotations for a particular
 * project.
 */
		...
		public void onServiceConnected(ComponentName className, IBinder service) {
			...
			try {
				...
				if (mRecordService.getState() == RecordService.State.STARTED.ordinal()) {
					((TextView) findViewById(R.id.record_instructions))
							.setText(R.string.recording_instructions_started);
					startedSession();
				}
			} catch (RemoteException e) {
			}
