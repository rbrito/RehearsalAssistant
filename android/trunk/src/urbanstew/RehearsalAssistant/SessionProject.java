...
public class SessionProject extends ProjectBase implements View.OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// Read sessions
		cursor = getContentResolver().query(Sessions.CONTENT_URI, sessionsProjection,
				Sessions.PROJECT_ID + "=" + projectId(), null, Sessions.DEFAULT_SORT_ORDER);
	...
	public boolean onContextItemSelected(MenuItem item) {
		...
		case MENU_ITEM_RECORD: {
			...
			if (!cursor.isNull(SESSIONS_END_TIME))
				Request.cancellable_confirmation(this, getString(R.string.warning),
						getString(R.string.warning_erase_previous_recordings), new OnClickListener() {
		...
		case MENU_ITEM_DELETE: {
			Request.cancellable_confirmation(this, getString(R.string.warning),
					getString(R.string.warning_erase_current_recordings), new OnClickListener() {
						public void onClick(DialogInterface arg0, int arg1) {
